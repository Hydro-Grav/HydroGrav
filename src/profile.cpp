...
// calculate csq(T)
// std::vector<double> FluidProfile::get_csq() const {
...
// Private functions
std::vector<prof_type> FluidProfile::read(const std::string& filename) const { // testing purposes ONLY
    ...
    prof_type xi_vals, v_vals, w_vals, la_vals;
